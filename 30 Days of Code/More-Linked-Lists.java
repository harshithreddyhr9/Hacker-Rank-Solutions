...
class Solution
{
    public static Node removeDuplicates(Node head) {
      //Write your code here
        ...
        Node current = head; // create a temp node to store the head node for traversing
        while(current.next!=null){ // while it is not the last node
            if(current.data == current.next.data){ // if the consecutive data fields in 2 nodes are same, change the link to the next node
